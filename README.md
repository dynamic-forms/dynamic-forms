...
### **Version 15** [![Build Status](https://dev.azure.com/alexandergebuhr/dynamic-forms/_apis/build/status/v15/dynamic-forms-v15-publish?branchName=refs/tags/15.0.0)](https://dev.azure.com/alexandergebuhr/dynamic-forms/_build/latest?definitionId=41&branchName=refs/tags/15.0.0)

- `npm install @dynamic-forms/core@15.0.0`
- `npm install @dynamic-forms/bootstrap@15.0.0`
- `npm install @dynamic-forms/material@15.0.0`
- `npm install @dynamic-forms/markdown@15.0.0`
