...
### **Version 21** [![Build Status](https://dev.azure.com/alexandergebuhr/dynamic-forms/_apis/build/status/dynamic-forms-publish?branchName=refs/tags/21.1.0)](https://dev.azure.com/alexandergebuhr/dynamic-forms/_build/latest?definitionId=45&branchName=refs/tags/21.1.0)

- `npm install @dynamic-forms/core@21.1.0`
- `npm install @dynamic-forms/bootstrap@21.1.0`
- `npm install @dynamic-forms/material@21.1.0`
- `npm install @dynamic-forms/markdown@21.1.0`
