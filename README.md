...
### **Version 16** [![Build Status](https://dev.azure.com/alexandergebuhr/dynamic-forms/_apis/build/status/dynamic-forms-publish?branchName=refs/tags/16.0.0-next.2)](https://dev.azure.com/alexandergebuhr/dynamic-forms/_build/latest?definitionId=45&branchName=refs/tags/16.0.0-next.2)

- `npm install @dynamic-forms/core@16.0.0-next.2`
- `npm install @dynamic-forms/bootstrap@16.0.0-next.2`
- `npm install @dynamic-forms/material@16.0.0-next.2`
- `npm install @dynamic-forms/markdown@16.0.0-next.2`
