...
### **Version 18** [![Build Status](https://dev.azure.com/alexandergebuhr/dynamic-forms/_apis/build/status/dynamic-forms-publish?branchName=refs/tags/18.1.0-rc.0)](https://dev.azure.com/alexandergebuhr/dynamic-forms/_build/latest?definitionId=45&branchName=refs/tags/18.1.0-rc.0)

- `npm install @dynamic-forms/core@18.1.0-rc.0`
- `npm install @dynamic-forms/bootstrap@18.1.0-rc.0`
- `npm install @dynamic-forms/material@18.1.0-rc.0`
- `npm install @dynamic-forms/markdown@18.1.0-rc.0`
