...
### **Version 13** [![Build Status](https://dev.azure.com/alexandergebuhr/dynamic-forms/_apis/build/status/v13/dynamic-forms-v13-publish?branchName=refs/tags/v13.0.0-next.1)](https://dev.azure.com/alexandergebuhr/dynamic-forms/_build/latest?definitionId=27&branchName=refs/tags/v13.0.0-next.1)

- `npm install @dynamic-forms/core@v13.0.0-next.1`
- `npm install @dynamic-forms/bootstrap@v13.0.0-next.1`
- `npm install @dynamic-forms/material@v13.0.0-next.1`
