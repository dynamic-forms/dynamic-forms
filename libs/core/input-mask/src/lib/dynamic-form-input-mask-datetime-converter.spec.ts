  ...
  describe('DynamicFormInputMaskNativeDatetimeConverter', () => {
    ...
    describe('format', () => {
      it('returns null if date is null', () => {
        const formatSpy = spyOn(formatter, 'format');
      ...
      it('returns formatted date', () => {
        const formatSpy = spyOn(formatter, 'format').and.returnValue('2024-01-01 12:00:00');
        ...
        expect(formatSpy).toHaveBeenCalledOnceWith(
