...
describe('DynamicFormLibraryService', () => {
  describe('with DYNAMIC_FORM_LIBRARY', () => {
    ...
    it('returns library, library names and library names in reverse order', inject(
      [DynamicFormLibraryService],
      (service: DynamicFormLibraryService) => {
    ...
    it('returns filtered types', inject([DynamicFormLibraryService], (service: DynamicFormLibraryService) => {
