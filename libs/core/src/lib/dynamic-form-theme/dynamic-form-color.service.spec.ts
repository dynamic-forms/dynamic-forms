...
describe('DynamicFormColorService', () => {
  describe('without color config', () => {
    ...
    it('returns icon config being empty', inject([DynamicFormColorService], (service: DynamicFormColorService) => {
    ...
    it('returns color', inject([DynamicFormColorService], (service: DynamicFormColorService) => {
      const color = service.getColor('color');

      expect(color).toBe('color');
    }));

    it('returns default color', inject([DynamicFormColorService], (service: DynamicFormColorService) => {
  ...
  describe('with color config', () => {
    ...
    it('returns color config', inject([DynamicFormColorService], (service: DynamicFormColorService) => {
      expect(service.colorConfig).toEqual(colorConfig);
    }));

    it('returns color being undefined', inject([DynamicFormColorService], (service: DynamicFormColorService) => {
      const color = service.getColor(undefined);

      expect(color).toBeUndefined();
    }));

    it('returns color not being mapped', inject([DynamicFormColorService], (service: DynamicFormColorService) => {
      const color = service.getColor('primary');

      expect(color).toBe('primary');
    }));

    it('returns color being mapped from config', inject([DynamicFormColorService], (service: DynamicFormColorService) => {
  ...
  describe('with color configs', () => {
    ...
    it('returns color config being merged', inject([DynamicFormColorService], (service: DynamicFormColorService) => {
      expect(service.colorConfig).toEqual({
        colors: {
          primaryColor: 'primary-test',
          secondaryColor: 'secondary-core',
