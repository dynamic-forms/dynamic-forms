...
export class DynamicFormInput3Control extends DynamicFormControl {}
...
describe('DynamicFormBuilder', () => {
  ...
  const inputTypes: DynamicFormInputTypeConfig = [
    ...
    { libraryName: 'test', type: 'input2', control: DynamicFormInput2Control, component: null },
    { libraryName: 'test', type: 'input2-extended', control: DynamicFormInput2Control, component: null },
  ...
  describe('createForm', () => {
    ...
    it('creates DynamicForm including DynamicFormControl', () => {
      const definition = {
        children: [{ key: 'key', type: 'control', template: { input: { type: 'input' } } } as DynamicFormControlDefinition],
      } as DynamicFormDefinition;
      const form = builder.createForm(definition, {});
  ...
  describe('createFormControl', () => {
    ...
    it('creates DynamicFormControl', () => {
      const model = {};
      const form = getForm(model);
      const definition = { key: 'key', type: 'control', template: { input: { type: 'input' } } } as DynamicFormControlDefinition;
      const control = builder.createFormControl(form, form, definition);
  ...
  describe('createFormArray', () => {
    ...
    it('creates DynamicFormArray', () => {
      const model = { key: [{}, {}] };
      const form = getForm(model);
      const definitionTemplate = { type: 'control', template: { input: { type: 'input' } } } as DynamicFormFieldDefinition;
    ...
    it('creates DynamicFormArray with definition template reference', () => {
      const model = { key: [{}, {}] };
      const reference = { type: 'control', template: { input: { type: 'input' } } } as DynamicFormFieldDefinition;
      const form = getForm(model, { 'array-control': reference });
  ...
  describe('createFormDictionary', () => {
    ...
    it('creates DynamicFormDictionary with definition template reference', () => {
      const model = { key: { value1: undefined, value2: undefined } };
      const reference = { type: 'control', template: { input: { type: 'input' } } } as DynamicFormFieldDefinition;
      const form = getForm(model, { 'dictionary-control': reference });
  ...
  describe('createFormElementForFactory', () => {
    ...
    it('creates DynamicFormField using factory of provided field type for array', () => {
      const model = {};
      const form = getForm(model);
    ...
    it('creates DynamicFormField using factory of provided field type for control', () => {
      const model = {};
      const form = getForm(model);
      const definition = { type: 'control', template: { input: { type: 'input' } } } as DynamicFormFieldDefinition;
      const field = builder.createFormFieldForFactory(form, form, definition);
    ...
    it('creates DynamicFormField using factory of provided field type for group', () => {
      const model = {};
      const form = getForm(model);
  ...
  describe('createFormActionForFactory', () => {
  ...
  describe('createFormControlAddOn', () => {
  ...
  describe('recreateFormControl', () => {
    it('returns control if control of current and previous input type is undefined', () => {
      const control = { inputType: 'input' } as DynamicFormControl;

      const result = builder.recreateFormControl(control, 'input1');

      expect(result).toBe(control);
    });

    it('returns control if control of current and previous input type is same', () => {
      const control = { inputType: 'input2' } as DynamicFormControl;

      const result = builder.recreateFormControl(control, 'input2-extended');

      expect(result).toBe(control);
    });

    it('returns new control if control of current input type is defined', () => {
      const model = {};
      const form = getForm(model);
    ...
    it('returns new control if control of previous input type is defined', () => {
      const model = {};
      const form = getForm(model);
      const definition = {} as DynamicFormControlDefinition;
      const type = {} as DynamicFormFieldType;
    ...
    it('returns new control if control of current and previous input type is defined but changed', () => {
      const model = {};
      const form = getForm(model);
      const definition = {} as DynamicFormControlDefinition;
      const type = {} as DynamicFormFieldType;
