...
export type DynamicFormGroupValidatorFn<Value extends Record<string, any> = any> = DynamicFormFieldValidatorFn<Value, FormGroupBase<Value>>;

export type DynamicFormGroupAsyncValidatorFn<Value extends Record<string, any> = any> = DynamicFormFieldAsyncValidatorFn<
  Value,
  FormGroupBase<Value>
>;
