...
describe('DynamicFormArray', () => {
  ...
  it('pushes field', () => {
    ...
    const field = { classType: 'field', definition: {}, control: new UntypedFormControl() }  as DynamicFormField;
  ...
  it('moves field down', () => {
    ...
    const formArray = new DynamicFormArray(builder, form, form, definition);
    const fields = [
      { classType: 'field', definition: { index: 0 }, control: new UntypedFormControl() } as DynamicFormField,
      { classType: 'field', definition: { index: 1 }, control: new UntypedFormControl() } as DynamicFormField
    ];
