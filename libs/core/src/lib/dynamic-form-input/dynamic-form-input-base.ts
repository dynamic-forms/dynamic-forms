...
export abstract class DynamicFormInputBase<
  ...
  Template extends DynamicFormControlTemplate<DynamicFormInputValue<Input>, Input> = DynamicFormControlTemplate<
    DynamicFormInputValue<Input>,
    Input
  >,
  Definition extends DynamicFormControlDefinition<DynamicFormInputValue<Input>, Input, Template> = DynamicFormControlDefinition<
    DynamicFormInputValue<Input>,
    Input,
    Template
  >,
  Control extends DynamicFormControl<DynamicFormInputValue<Input>, Input, Template, Definition> = DynamicFormControl<
    DynamicFormInputValue<Input>,
    Input,
    Template,
    Definition
