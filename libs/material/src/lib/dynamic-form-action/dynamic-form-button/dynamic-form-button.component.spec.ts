...
describe('MatDynamicFormButtonComponent', () => {
  ...
  it('sets dynamic form button to hidden', () => {
    ...
    expect(formButtonElement.className).toBe('dynamic-form-button mat-flat-button mat-button-base mat-primary');

    component.template.hidden = true;
    fixture.detectChanges();

    expect(formButtonElement.className).toBe('dynamic-form-button mat-flat-button mat-button-base mat-primary hidden');
  });
  ...
  it('sets class name of dynamic form button', () => {
    ...
    expect(formButtonElement.className).toBe('dynamic-form-button mat-flat-button mat-button-base mat-primary className1 className2');
